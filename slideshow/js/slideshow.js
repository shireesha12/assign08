...
var createSlideshow = function () {
    ...
    var timer, play = true, nodes, img, stopSlideShow, displayNextImage, setPlayText, speed, defaultSpeed = 2000;
    ...
    return {
        ...
        interval: function () {            
            ...
            return function () {
                ...
                // 'ME' IS THE OBJECT LITERAL
                if (speed) {
                    speed = window.prompt("current speed is: " + defaultSpeed + "! Do you want to change it");
...
window.addEventListener("load", function () {
    ...
    $("speed").onclick = slideshow.interval();
});